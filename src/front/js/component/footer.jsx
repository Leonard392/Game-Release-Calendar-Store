...
export const Footer = () => (
	...
	<div className="sb_footer-below">
		<div className="sb_footer-copyright">
			<p>
				@{new Date().getFullYear()} Ninja Station. All right deserved.
			</p>
		</div>
		<div className="sb_footer-below-links">
			<Link to="/" className="footer-link">
				<p className="footer-link-p">Terms a& Conditions</p>
			</Link>
			<Link to="/" className="footer-link">
				<p className="footer-link-p">Privacy</p>
			</Link>
			<Link to="/" className="footer-link">
				<p className="footer-link-p">Security</p>
			</Link>
			<Link to="/" className="footer-link">
				<p className="footer-link-p">Cookie Declaration</p>
			</Link>
		</div>
	</div>
		</div>
